...
public class ApproximateDominanceAnalysis implements Analysis{
    ...
    ApproximateDominanceAnalysis(List<Integer> betterIn, List<Integer> worseIn, FeatureSet featureSet){
    ...
    public void executeAndWriteLineToReport(TetrisState stateBefore, TetrisAction action) {
        ...
        //count pareto
        boolean[] pareto = LinearDecisionRule.paretoDominanceApprSet(weightArray, objects, betterIn, worseIn);
        int numPareto = 0;
